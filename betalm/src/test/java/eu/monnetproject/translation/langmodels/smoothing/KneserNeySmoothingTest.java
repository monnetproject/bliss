...
public class KneserNeySmoothingTest {
    ...
    public void testNgramScores() {
        ...
        assertArrayEquals(new double[] { Math.log10(1e-10), -0.051152522447381256 }, instance.ngramScores(ng(1),countSet), 0.01);
        assertArrayEquals(new double[] { Math.log10(1e-10), -0.051152522447381256 }, instance.ngramScores(ng(2),countSet),0.01);
        assertArrayEquals(new double[] { Math.log10(1.0/15.0), -0.17609125905568118 }, instance.ngramScores(ng(3),countSet),0.01);
        assertArrayEquals(new double[] { Math.log10(1.0/5.0), -0.17609125905568118 }, instance.ngramScores(ng(4),countSet),0.01);
